...
<div class="wp-block-group alignfull has-neutral-100-background-color has-background" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--md)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--xl)">
        ...
        <h2 class="wp-block-heading has-text-align-center" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--sm);font-size:clamp(2rem, 4vw, 3rem);font-weight:800;letter-spacing:-0.02em;line-height:1.2">
            <?php echo esc_html__( 'Latest Articles', 'versana' ); ?></h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"neutral-700","fontSize":"md"} -->
        <p class="has-text-align-center has-neutral-700-color has-text-color has-md-font-size" style="margin-top:0;margin-bottom:0"><?php echo esc_html__( 'Explore our most recent posts and stay updated with the latest insights.', 'versana' ); ?></p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-query alignwide">
        <!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|lg"}},"layout":{"type":"grid","columnCount":null,"minimumColumnWidth":"20rem"}} -->
        ...
        <div class="wp-block-group has-border-color has-neutral-100-background-color has-background" style="border-color:var(--wp--preset--color--neutral-300);border-width:1px;border-radius:12px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
    ...
    <div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--xl)">
        ...
        <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="/blog" style="border-radius:8px"><?php echo esc_html__( 'View All Posts →', 'versana' ); ?></a></div>
        <!-- /wp:button -->
    </div>
    <!-- /wp:buttons -->
</div>
