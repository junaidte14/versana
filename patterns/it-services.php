...
/**
 * Title: Our Services
 * Slug: versana/it-services
 * Categories: versana-sections
 * Keywords: services, 2 columns, features
 * Block Types: core/group
 * Description: A large section to showcase top IT services.
 */
?>
...
<div class="wp-block-group alignwide"
    style="padding-top:var(--wp--preset--spacing--2-xl);padding-bottom:var(--wp--preset--spacing--xl)">
