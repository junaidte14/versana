...
<main class="wp-block-group" style="padding-top:var(--wp--preset--spacing--2-xl);padding-bottom:var(--wp--preset--spacing--2-xl)">
    ...
    <div class="wp-block-group alignwide">
        ...
        <h2 class="wp-block-heading has-text-align-center"
            style="margin-top:0;margin-bottom:var(--wp--preset--spacing--md)">
            <?php echo esc_html__( 'Page Not Found', 'versana' ); ?>
        </h2>
        <!-- /wp:heading -->
        ...
        <p class="has-text-align-center has-neutral-700-color has-text-color has-md-font-size"
            style="margin-top:0;margin-bottom:var(--wp--preset--spacing--lg)">
            <?php echo esc_html__( "The page you're looking for doesn't exist or has been moved. Let's get you back on track.", 'versana' ); ?>
        </p>
        <!-- /wp:paragraph -->

        <!-- wp:search {"label":"<?php echo esc_attr__( 'Search', 'versana' ); ?>","showLabel":false,"placeholder":"<?php echo esc_attr__( 'Search for content...', 'versana' ); ?>","width":100,"widthUnit":"%","buttonText":"<?php echo esc_html__( 'Search', 'versana' ); ?>","buttonPosition":"button-inside","buttonUseIcon":true,"style":{"border":{"radius":"8px"}}} /-->
        ...
        <h3 class="wp-block-heading has-text-align-center"
            style="margin-top:0;margin-bottom:var(--wp--preset--spacing--md)">
            <?php echo esc_html__( 'Helpful Links', 'versana' ); ?>
        </h3>
        <!-- /wp:heading -->
        ...
        <!-- wp:navigation {
            ...
            "style":{"spacing":{"blockGap":"var:preset|spacing|sm"}},
            "layout":{
                "type":"flex",
        ...
        <div class="wp-block-buttons" style="margin-top:0">
            ...
            <div class="wp-block-button has-custom-width wp-block-button__width-100">
                <a class="wp-block-button__link wp-element-button" href="/">
                    <?php echo esc_html__( '← Back to Homepage', 'versana' ); ?>
                </a>
            </div>
            <!-- /wp:button -->
        </div>
