...
<div class="wp-block-group alignfull has-neutral-200-background-color has-background" style="padding-top:var(--wp--preset--spacing--2-xl);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--2-xl);padding-left:var(--wp--preset--spacing--md)">
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--xl)">
        ...
        <h2 class="wp-block-heading has-text-align-center" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--sm);font-size:clamp(2rem, 4vw, 3rem);font-weight:800;letter-spacing:-0.02em;line-height:1.2">
            <?php echo esc_html__( 'Our Services', 'versana' ); ?>
        </h2>
        <!-- /wp:heading -->

        <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"neutral-700","fontSize":"md"} -->
        <p class="has-text-align-center has-neutral-700-color has-text-color has-md-font-size" style="margin-top:0;margin-bottom:0">
            <?php echo esc_html__( 'Comprehensive solutions tailored to your business needs', 'versana' ); ?>
        </p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)">
            ...
            <h3 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'Web Development', 'versana' ); ?></h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">
                <?php echo esc_html__( 'Custom websites built with modern technologies for optimal performance', 'versana' ); ?>
            </p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)">
            ...
            <!-- wp:heading {"textAlign":"center","level":3} -->
            <h3 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'Digital Marketing', 'versana' ); ?></h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">
                <?php echo esc_html__( 'Strategic marketing campaigns that drive results and grow your presence', 'versana' ); ?>
            </p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)">
            ...
            <!-- wp:heading {"textAlign":"center","level":3} -->
            <h3 class="wp-block-heading has-text-align-center"><?php echo esc_html__( 'Consulting', 'versana' ); ?></h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">
                <?php echo esc_html__( 'Expert guidance to help you make informed decisions and achieve goals', 'versana' ); ?>
            </p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
