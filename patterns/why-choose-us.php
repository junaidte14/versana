...
<div class="wp-block-group alignfull has-neutral-200-background-color has-background"
    ...
    <div class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--xl)">
        ...
        <p class="has-text-align-center has-neutral-700-color has-text-color has-md-font-size"
            style="margin-top:0;margin-bottom:0">Everything you need to create, share, and grow your content.</p>
        <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-columns alignwide">
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background"
            ...
            <h3 class="wp-block-heading has-text-align-center"
                style="margin-top:0;margin-bottom:var(--wp--preset--spacing--sm)">Quality Content</h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">Expert-written articles covering
                diverse topics with depth and clarity.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background"
            ...
            <!-- wp:heading {"textAlign":"center","level":3,"style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|sm"}}}} -->
            <h3 class="wp-block-heading has-text-align-center"
                style="margin-top:0;margin-bottom:var(--wp--preset--spacing--sm)">Regular Updates</h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">Fresh content published daily to
                keep you informed and inspired.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-neutral-100-background-color has-background"
            ...
            <!-- wp:heading {"textAlign":"center","level":3,"style":{"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|sm"}}}} -->
            <h3 class="wp-block-heading has-text-align-center"
                style="margin-top:0;margin-bottom:var(--wp--preset--spacing--sm)">Community Driven</h3>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"align":"center","textColor":"neutral-700"} -->
            <p class="has-text-align-center has-neutral-700-color has-text-color">Join thousands of readers sharing
                ideas and engaging in discussions.</p>
            <!-- /wp:paragraph -->
        </div>
        <!-- /wp:column -->
    </div>
